...
def Ref():
    ...
    Corice_beans = float(rice_beans.get())
    ...
    Costofrice_beans = Corice_beans * 2.5
    ...
    CostofMeal = ("rtgs", str("%.2f" % (Costofsadza_beans + Costofsadza_beef + Costofrice_beef +
                                       Costofrice_chicken + Costofsadza_chicken + Costofrice_beans + Costofrice_soup +
...
lblrice_beans = Label(f1, font=('arial', 16, 'bold'), text="Rice beans", bd=16, anchor="w")
lblrice_beans.grid(row=6, column=0)
txtrice_beans = Entry(f1, font=('arial', 16, 'bold'), textvariable=rice_beans, bd=10, insertwidth=4,
                      bg='powder blue', justify='right')
txtrice_beans.grid(row=6, column=1)
